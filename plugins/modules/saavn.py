...
BUTTONS = InlineKeyboardMarkup([[InlineKeyboardButton('ᴏᴜʀ ᴄʜᴀɴɴᴇʟ ʟɪɴᴋ', url='https://t.me/pathan_botz')]])
...
#   album_id = r.json()[0]["albumid"]
    ...
    buttons = [[
        InlineKeyboardButton("ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ ᴊᴏɪɴ ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ", url="https://t.me/pathans_moviez")
    ]]                           
...
async def r_message(client, message):
    ...
    buttons = [[
        InlineKeyboardButton('𝐉𝐨𝐢𝐧 𝐆𝐫𝐨𝐮𝐩', url=f'http://t.me/pathans_movies')
    ]]
    reply_markup = InlineKeyboardMarkup(buttons)
