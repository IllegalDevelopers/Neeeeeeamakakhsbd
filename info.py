...
URL = "https://feminist-marketa-muzanbot-ee3c813c.koyeb.app/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://feminist-marketa-muzanbot-ee3c813c.koyeb.app/".format(FQDN, PORT)
